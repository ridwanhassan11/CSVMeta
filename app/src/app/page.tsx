          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="rounded-xl bg-rose-100 dark:bg-rose-900/40 px-5 py-2.5 text-sm font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-200 dark:hover:bg-rose-900/60 disabled:opacity-40"
              >
                🗑 Clear All
              </button>
              ...
              {generating && (
                <button
                  ...
                  className="rounded-xl bg-amber-100 dark:bg-amber-900/40 px-5 py-2.5 text-sm font-semibold text-amber-700 dark:text-amber-400 hover:bg-amber-200 dark:hover:bg-amber-900/60"
                >
                  ⏹ Stop Generate
                </button>
              )}
              ...
              <button
                ...
                className="rounded-xl bg-slate-900 dark:bg-white px-5 py-2.5 text-sm font-semibold text-white dark:text-slate-900 hover:bg-slate-700 dark:hover:bg-slate-200 disabled:opacity-40"
              >
                {generating ? "Generating..." : `✨ Generate All (${pendingCount})`}
              </button>
              <button
                onClick={exportCSV}
                disabled={doneCount === 0}
                className="rounded-xl bg-slate-100 dark:bg-slate-800 px-5 py-2.5 text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 disabled:opacity-40"
              >
                ⬇ Export CSV
              </button>
            </div>
