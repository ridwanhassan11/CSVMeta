...
const PROVIDER_META: Record<Provider, ProviderMetaEntry> = {
  gemini: {
    name: "Google Gemini",
    tagline: "Google's model for image analysis and text generation",
    badge: "Free & Paid",
  ...
  groq: {
    name: "Groq",
    tagline: "Open-source model hosting known for ultra-fast inference",
    badge: "Paid",
  ...
  mistral: {
    name: "Mistral AI",
    tagline: "Generates image metadata using the Pixtral vision model",
    badge: "Paid",
  ...
  openai: {
    name: "OpenAI",
    tagline: "Image analysis and metadata generation using the GPT-4o series",
    badge: "Paid",
  ...
  openrouter: {
    name: "OpenRouter",
    tagline: "Access many providers' models with a single API key",
    badge: "Paid",
      ...
      <div className="flex w-full max-w-3xl overflow-hidden rounded-3xl bg-white dark:bg-slate-900 text-slate-900 dark:text-white shadow-2xl">
        <div className="w-56 shrink-0 border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 p-4">
          ...
          <p className="mt-6 px-2 text-[11px] leading-relaxed text-slate-400">
            Your keys are stored only in your browser and are never sent anywhere else.
          </p>
        </div>
